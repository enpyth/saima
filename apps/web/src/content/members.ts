...
const memberImages = {
  ...
  bowen: '/images/saima/members/Bowen.jpg',
  harper: '/images/saima/members/Harper.jpg',
} as const
  ...
  en: {
    ...
    members: [
      ...
      },
      {
        order: 10,
        slug: 'bowen-huang',
        href: '/members/bowen-huang',
        name: 'Bowen Huang',
        role: 'Guqin Performer and Interdisciplinary Arts Practitioner',
        specialty: 'Guqin / Arts wellbeing / Music, psychology and technology',
        image: memberImages.bowen,
        summary:
          'A guqin performer whose interdisciplinary practice connects traditional music, psychology, technology, wellbeing and cultural dialogue.',
        bio: [
          'Bowen Huang is a guqin performer based in Adelaide, Australia, with an interdisciplinary academic background in Applied Psychology and Electronic Engineering.',
          'He has devoted himself to the long-term study and practice of the traditional Chinese guqin, exploring its rich aesthetic traditions, humanistic philosophy, and contemporary relevance.',
          'In addition to his musical practice, Bowen holds master degrees in both Applied Psychology and Electronic Engineering.',
          'His interdisciplinary background informs an artistic practice that connects music, psychology, technology, and culture, with particular interests in emotional wellbeing, attention development, and the therapeutic potential of music and the arts.',
          'With over ten years of experience in guqin teaching and artistic practice, he is committed to exploring the role of traditional music in cultural engagement, personal wellbeing, and cross-cultural dialogue.',
          'As a member of SAIMA, Bowen actively contributes through performances, education, cultural exchange, and community projects, promoting the guqin within an international context while fostering intercultural understanding and artistic dialogue.',
        ],
      },
      {
        order: 11,
        slug: 'harper-ou',
        href: '/members/harper-ou',
        name: 'Harper Ou',
        role: 'Guzheng Performer and Educator',
        specialty: 'Guzheng / Chinese traditional instruments / Music education',
        image: memberImages.harper,
        summary:
          'A guzheng performer with nearly two decades of training in Chinese traditional music, performance and education.',
        bio: [
          'Harper Ou began studying the guzheng at the age of five under the guidance of Mr. Liu Ge, a distinguished guzheng performer with the Hubei Provincial Song and Dance Theatre.',
          'Through years of dedicated training, she established a strong foundation in traditional Chinese instrumental performance.',
          'She later pursued a Bachelor of Music in Guzheng Performance at the Wuhan Conservatory of Music, where she studied under Associate Professor Hu Jing of the Department of Chinese Traditional Instruments.',
          'During her undergraduate studies, she received comprehensive professional training in guzheng performance, music interpretation, ensemble collaboration, stage performance, and Chinese traditional music.',
          'With nearly two decades of musical training, Harper combines solid technical proficiency with a deep understanding of Chinese musical traditions.',
          'Her educational background and performance experience provide a strong foundation for both concert performance and music education.',
        ],
      },
    ],
  },
  zh: {
    ...
    members: [
      ...
      },
      {
        ...
        name: 'Bowen Huang',
        role: '古琴演奏者及跨学科艺术实践者',
        specialty: '古琴 / 艺术疗愈与身心健康 / 音乐、心理与科技',
        image: memberImages.bowen,
        summary: '古琴演奏者，跨学科实践连接传统音乐、心理学、科技、身心健康与文化对话。',
        bio: [
          'Bowen Huang 是现居澳大利亚阿德莱德的古琴演奏者，拥有应用心理学和电子工程的跨学科学术背景。',
          '他长期投入中国传统古琴的学习与实践，探索古琴丰富的审美传统、人文哲思和当代意义。',
          '除音乐实践外，Bowen 拥有应用心理学和电子工程两个硕士学位。',
          '他的跨学科背景塑造了连接音乐、心理学、科技与文化的艺术实践，并尤其关注情绪健康、注意力发展，以及音乐和艺术的疗愈潜力。',
          '凭借十余年的古琴教学与艺术实践经验，他致力于探索传统音乐在文化参与、个人身心健康和跨文化对话中的作用。',
          '作为 SAIMA 成员，Bowen 通过演出、教育、文化交流和社区项目积极参与协会工作，在国际语境中推广古琴，同时促进跨文化理解和艺术对话。',
        ],
      },
      {
        order: 11,
        ...
        name: 'Harper Ou',
        role: '古筝演奏者及教育工作者',
        specialty: '古筝 / 中国传统器乐 / 音乐教育',
        image: memberImages.harper,
        summary: '古筝演奏者，拥有近二十年中国传统音乐、舞台表演和音乐教育训练背景。',
        bio: [
          'Harper Ou 五岁开始学习古筝，师从湖北省歌舞剧院著名古筝演奏家刘戈老师。',
          '经过多年系统训练，她在中国传统器乐演奏方面建立了扎实基础。',
          '之后，她在武汉音乐学院攻读古筝表演音乐学士学位，师从中国器乐系胡菁副教授。',
          '本科期间，她接受了古筝演奏、音乐诠释、重奏合作、舞台表演和中国传统音乐等方面的全面专业训练。',
          '凭借近二十年的音乐训练，Harper 兼具扎实的技术能力和对中国音乐传统的深入理解。',
          '她的教育背景和演出经验为音乐会表演和音乐教育奠定了坚实基础。',
        ],
      },
    ],
  },
